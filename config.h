...
const uchar at_code[] = "\0,AT,AT+RST,AT+GMR,AT+GSLP,ATE,AT+RESTORE,AT+UART?,AT+UART_CUR,AT+UART_DEF,AT+SLEEP,AT+WAKEUPGPIO,AT+RFPOWER,AT+RFVDD,AT+RFAUTOTRACE,AT+SYSRAM,AT+SYSADC,AT+SYSIOSETCFG,AT+SYSIOGETCFG,AT+SYSGPIODIR,AT+SYSGPIOWRITE,AT+SYSGPIOREAD,AT+CWMODE,AT+CWMODE_CUR,AT+CWMODE_DEF,AT+CWJAP,AT+CWJAP_CUR,AT+CWJAP_DEF,AT+CWLAPOPT,AT+CWLAP\0";//
